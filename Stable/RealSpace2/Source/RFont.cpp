...
*/
			...
			{
				if (key == 209 || (key >= 212 && key <= 218) || (key >= 231 && key <= 237))
				{
					// 0 left bottom | 1 left top | 2 right top | 3 right bottom
					if (RFont::m_nLastText == 209 || (RFont::m_nLastText >= 212 && RFont::m_nLastText <= 215)) // LastText
					{
						vertices[0].p = D3DXVECTOR4(x - w, y - (h * 0.25), 0, 1);
						vertices[1].p = D3DXVECTOR4(x - w, y + h - (h * 0.25), 0, 1);
						vertices[2].p = D3DXVECTOR4(x, y + h - (h * 0.25), 0, 1);
						vertices[3].p = D3DXVECTOR4(x, y - (h * 0.25), 0, 1);
					}
					else if (key == 209 || (key >= 212 && key <= 215))
					{
						vertices[0].p = D3DXVECTOR4(x - w, y - (h * 0.15), 0, 1);
						vertices[1].p = D3DXVECTOR4(x - w, y + h - (h * 0.15), 0, 1);
						vertices[2].p = D3DXVECTOR4(x, y + h - (h * 0.15), 0, 1);
						vertices[3].p = D3DXVECTOR4(x, y - (h * 0.15), 0, 1);
					}
					else if ((key >= 216 && key <= 218))
					{
						vertices[0].p = D3DXVECTOR4(x - w, y + (h * 0.15), 0, 1);
						vertices[1].p = D3DXVECTOR4(x - w, y + h + (h * 0.15), 0, 1);
						vertices[2].p = D3DXVECTOR4(x, y + h + (h * 0.15), 0, 1);
					...
					else if (RFont::m_nLastText == 211 && (key >= 231 && key <= 237)) // LastText sa ra aum
					{
						vertices[0].p = D3DXVECTOR4(x - (w * 1.5), y - (h * 0.25), 0, 1);
						vertices[1].p = D3DXVECTOR4(x - (w * 1.5), y + h - (h * 0.25), 0, 1);
						vertices[2].p = D3DXVECTOR4(x - (w * 0.5), y + h - (h * 0.25), 0, 1);
						vertices[3].p = D3DXVECTOR4(x - (w * 0.5), y - (h * 0.25), 0, 1);
					}
					else
					{
						vertices[0].p = D3DXVECTOR4(x - w, y, 0, 1);
						vertices[1].p = D3DXVECTOR4(x - w, y + h, 0, 1);
						vertices[2].p = D3DXVECTOR4(x, y + h, 0, 1);
						vertices[3].p = D3DXVECTOR4(x, y, 0, 1);
					}
				}
				else if (key == 211) // Input 
				{
					vertices[0].p = D3DXVECTOR4(x - (w * 0.5), y, 0, 1);
					vertices[1].p = D3DXVECTOR4(x - (w * 0.5), y + h, 0, 1);
					vertices[2].p = D3DXVECTOR4(x + (w * 0.5), y + h, 0, 1);
					vertices[3].p = D3DXVECTOR4(x + (w * 0.5), y, 0, 1);
				}
				else
				{
					vertices[0].p = D3DXVECTOR4(x, y, 0, 1);
			...
			if (key == 211)
			{
				x += ((pInfo->nWidth * fScale) / 2);
			}
			else if (key == 209 || (key >= 212 && key <= 218) || (key >= 231 && key <= 237))
			{
				//
			}
			else if (m_nOutlineStyle == 1)
			{
				x += min((pInfo->nWidth * fScale + 1), CELL_SIZE); // [Fix] Font Thai
			}
			else
			{
				x += (pInfo->nWidth * fScale); // [Fix] Font Thai
			}

		}

		RFont::m_nLastText = key;
